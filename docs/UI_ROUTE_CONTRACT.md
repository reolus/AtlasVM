...
This contract is the cleanup target for the Phase 11.5 UI overhaul before Phase 12 multi-node testing.
...
|---|---|---|---|
| GET | `/vms` | Node-aware VM inventory | `multinode_vm_inventory()` |
